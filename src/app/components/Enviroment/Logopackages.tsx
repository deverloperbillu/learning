...
import Logopackagedata from './All_packagedata/Logopackagedata';
import { IoCheckmarkOutline } from "react-icons/io5";


const Logopackages: React.FC = () => {
const [selectPackages, setSelectPackages] = useState<typeof Logopackagedata[0] | null>(null);

const handlepackageclick = (packageId: string) => {
    const packing = Logopackagedata.find(pkg => pkg.id === packageId);
    if(packing){
